...
module.exports = (function() {
    ...
    var adapter = {
        ...
        registerConnection: function(connection, collections, cb) {
            ...
            if (connection.skipStructureVerification) {
                console.log("Skipping describe and structure verification")
        ...
        count: function(connectionName, table, options, cb) {
            ...
            connectionObject.pool.getConnection(
                function(err, connection) {
                    ...
                    connection.execute(_query.query[0], _query.values[0], {
                        outFormat: oracledb.OBJECT
                    }, function __COUNT__(err, result) {
                        if (err) {
                            /* Release the connection back to the connection pool */
                            doRelease(connection);
